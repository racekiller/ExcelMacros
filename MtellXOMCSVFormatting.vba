Option Explicit
Public SegmentCSV, Segment, PHDTagName, PHDTagDescription, Asset  As String
...
Data = getDataFromFile(parFileName, parDelimiter)
    ...
    ActiveWorkbook.SaveAs Filename:= _
        "F:\Dropbox\Mtell Customer Projects\XOM BMT Phase 2 Live Monitoring\Sensor Data\Phase 1\C-308\" & Asset & "_" & Segment & "_" & PHDTagName & ".csv" _
